...
μ (мю) — функція приналежності через квадратичний S-сплайн з порогами (a, b, c)
ϑ (тета) — зважена агрегація: ϑ = Σ(μᵢ × wᵢ), де w — нормалізовані ваги
LFC (Level of Familiarity with Cybersecurity) — лінгвістична оцінка на основі середнього ϑ̅

Рівні LFC:

Високий рівень (ϑ̅ > 0.8)
Вище середнього (0.6 < ϑ̅ ≤ 0.8)
Середній рівень (0.4 < ϑ̅ ≤ 0.6)
Низький рівень (0.2 < ϑ̅ ≤ 0.4)
Дуже низький рівень (ϑ̅ ≤ 0.2)

Налаштування:

Вагові коефіцієнти v₁-v₄ для кожної групи (1-10)
...
SheetJS (xlsx) для роботи з Excel
Нечітка логіка для оцінювання
